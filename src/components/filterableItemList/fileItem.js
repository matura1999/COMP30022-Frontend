    ...
    <div className="fileItem__item">
      <div className="fileItem__iconAndInfo">
        ...
        <div className="fileItem__info">
          <div className="fileItem__title" data-testid="fileItem-name">
            {name}
          </div>

          <div className="fileItem__typeSizeContainer">
            <div className="fileItem__type" data-testid="fileItem-type">
              {type} File
            </div>
            <div className="fileItem__size" data-testid="fileItem-size">
              {size}
            </div>
          </div>

          <div className="fileItem__date" data-testid="fileItem-date">
            {date}
          </div>
        </div>
      </div>
